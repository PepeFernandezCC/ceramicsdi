...
require_once(dirname(__FILE__).'/models/SdevAdeoImportLogs.php');
require_once(dirname(__FILE__).'/models/SdevAdeoLogisticClass.php');
require_once(dirname(__FILE__).'/exception/WrongApiReturnException.php');
