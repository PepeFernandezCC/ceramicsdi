...
namespace Scaledev\MiraklPhpConnector\Field\Product\ExportProductFile\FileGenerator;
...
/**
 * Class ProductFileField
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class ProductFileField extends AbstractField
{
    /**
     * @inheritdoc
     */
     ...
     * @inheritdoc
     */
    const TYPE = ProductCollection::class;
