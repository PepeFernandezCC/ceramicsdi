			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane active panel" id="tagmanager">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="control-label col-lg-3" rel="only_map">{l s='Add customer informations' mod='cdc_googletagmanager'}</label>
							<div class="margin-form col-lg-3">
								<span class="switch prestashop-switch fixed-width-lg">
									<input type="radio" name="CDC_GTM_CUSTOMER_INFORMATIONS" id="CUSTOMER_INFORMATIONS_ON"  value="1" {if $CDC_GTM_CUSTOMER_INFORMATIONS}checked{/if} /><label for="CUSTOMER_INFORMATIONS_ON" class="label-checkbox">{l s='Yes' mod='cdc_googletagmanager'}</label>
									<input type="radio" name="CDC_GTM_CUSTOMER_INFORMATIONS" id="CUSTOMER_INFORMATIONS_OFF" value="0" {if !$CDC_GTM_CUSTOMER_INFORMATIONS}checked{/if} /><label for="CUSTOMER_INFORMATIONS_OFF" class="label-checkbox">{l s='No' mod='cdc_googletagmanager'}</label>
									<a class="slide-button btn"></a>
								</span>
							</div>
							<div class="col-lg-6">
								<p class="cdc-info">{l s='Add customer informations on the datalayer on each page (email, past orders, is new)' mod='cdc_googletagmanager'}.</p>
							</div>
						</div>
