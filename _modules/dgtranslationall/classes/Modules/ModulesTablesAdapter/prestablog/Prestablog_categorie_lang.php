...
if (!class_exists('Prestablog_categorie_lang')) {
    class Prestablog_categorie_lang extends \Dingedi\TablesTranslation\DgTableTranslatable17
    {
        /**
         * @var string|false
         */
         ...
         * @var string
         */
        public $table = 'prestablog_categorie_lang';

        public function __construct()
        {
            $primary_key = 'id_prestablog_categorie';

            $fields = array('title', 'meta_description', 'meta_keywords', 'meta_title', 'link_rewrite', 'description');
        ...
        {
            return parent::supportController($controller, $checkHasId) && \Tools::getValue('editCat') !== false;
        }
