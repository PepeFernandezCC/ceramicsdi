...
if (!class_exists('Prestablog_popup_lang')) {
    class Prestablog_popup_lang extends \Dingedi\TablesTranslation\DgTableTranslatable17
    {
        /**
         * @var string|false
         */
         ...
         * @var string
         */
        public $table = 'prestablog_popup_lang';

        public function __construct()
        {
            $primary_key = 'id_prestablog_popup';
        ...
        {
            return parent::supportController($controller, $checkHasId) && \Tools::getValue('editpopup') !== false;
        }
