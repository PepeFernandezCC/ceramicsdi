				...
				<div class="form-group">
					...
					<div class="col-xs-3">
						<select name="bt_cl-statut" id="bt_cl-statut">
							<option value="1" {if isset($bActive) && $bActive == 1} selected="selected" {/if}>{l s='Yes' mod='gmerchantcenterpro'}</option>
							<option value="0" {if isset($bActive) && $bActive == 0} selected="selected" {/if}>{l s='No' mod='gmerchantcenterpro'}</option>
						</select>
					</div>
				</div>
					...
					<div class="col-xs-3">
						<select name="bt_cl_association" id="bt_cl-statut">
							{foreach from=$labelPosition key=myKey item=position}
								<option value="{$position|escape:'htmlall':'UTF-8'}" {if isset($customLabelSetPosition) && $customLabelSetPosition == $position} selected {/if}>{$position|escape:'htmlall':'UTF-8'}</option>
							{/foreach}
						</select>
					</div>
				</div>
					...
					<div class="col-xs-3">
						<div class="col-xs-8">
							<div class="input-group">
								...
								<input type="text" name="bt_cl_date_end" id="bt_cl_date_end" class="date-picker" value="{if isset($sDate)}{$sDate|escape:'htmlall':'UTF-8'}{/if}" />
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-xs-12" id="bt_cl_configure_new_products">
							...
							<div class="form-group">
								...
								<div class="col-xs-2">
									<div class="input-group">
										<span class="input-group-addon"><i class="icon icon-calendar"></i> &nbsp; </span>
										<input type="text" name="bt_cl_dyn_date_start" id="bt_cl_dyn_date_start" class="date-picker" value="{if isset($sDateNewPoduct)}{$sDateNewPoduct|escape:'htmlall':'UTF-8'}{/if}" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-xs-12" id="bt_cl_configure_last_order">
							...
							<div class="col-xs-2">
								<div class="input-group">
									...
									<input type="text" name="bt_dyn_last_order_start" id="bt_dyn_last_order_start" class="date-picker" value="{if isset($sStartDateLastOrdered)}{$sStartDateLastOrdered|escape:'htmlall':'UTF-8'}{/if}" />
								</div>
							</div>
							...
							<div class="col-xs-2">
								<div class="input-group">
									...
									<input type="text" name="bt_dyn_last_order_end" id="bt_dyn_last_order_end" class="date-picker" value="{if isset($sEndDateLastOrdered)}{$sEndDateLastOrdered|escape:'htmlall':'UTF-8'}{/if}" />
								</div>
							</div>
						</div>
						...
						<div class="col-xs-12" id="bt_cl_configure_not_sell">
							...
							<div class="col-xs-2">
								<div class="input-group">
									<span class="input-group-addon"><i class="icon icon-calendar"></i> &nbsp; {l s='From' mod='gmerchantcenterpro'} </span>
									<input type="text" name="bt_dyn_not_sell_start" id="bt_dyn_not_sell_start" class="date-picker" value="{if isset($startNotSell)}{$startNotSell|escape:'htmlall':'UTF-8'}{/if}" />
								</div>
							</div>
							...
							<div class="col-xs-2">
								<div class="input-group">
									<span class="input-group-addon"><i class="icon icon-calendar"></i> &nbsp; {l s='To' mod='gmerchantcenterpro'} </span>
									<input type="text" name="bt_dyn_not_sell_end" id="bt_dyn_not_sell_end" class="date-picker" value="{if isset($endNotSell)}{$endNotSell|escape:'htmlall':'UTF-8'}{/if}" />
								</div>
							</div>
						</div>
						...
						<div class="col-xs-12" id="bt_cl_configure_best_sales">
							...
							<div class="form-group">
								...
								<div class="col-xs-3">
									<div class="input-group">
										<input type="text" name="bt_cl_dyn_amount" id="bt_cl_dyn_amount" value="{if isset($fAmount)}{$fAmount|floatval}{else}0{/if}" />
							...
							<div class="form-group" id="bt_cl_best_sale_from">
								...
								<div class="col-xs-3">
									<div class="input-group">
										<span class="input-group-addon"><i class="icon icon-calendar"></i> &nbsp; {l s='From' mod='gmerchantcenterpro'} </span>
										<input type="text" name="bt_dyn_best_sale_start" id="bt_dyn_best_sale_start" class="date-picker" value="{if isset($sStartDate)}{$sStartDate|escape:'htmlall':'UTF-8'}{/if}" />
									</div>
								</div>
								...
								<div class="col-xs-3">
									<div class="input-group">
										<span class="input-group-addon"><i class="icon icon-calendar"></i> &nbsp; {l s='To' mod='gmerchantcenterpro'} </span>
										<input type="text" name="bt_dyn_best_sale_end" id="bt_dyn_best_sale_end" class="date-picker" value="{if isset($sEndDate)}{$sEndDate|escape:'htmlall':'UTF-8'}{/if}" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xs-12" id="bt_cl_configure_price_range">
							...
							<div class="col-xs-3">
								<div class="input-group">
									...
									<input type="text" name="bt_dyn_min_price" id="bt_dyn_min_price" value="{if isset($fPriceMin)}{$fPriceMin|floatval}{else}0{/if}" />
								</div>
							</div>
							...
							<div class="col-xs-3">
								<div class="input-group">
									...
									<input type="text" name="bt_dyn_max_price" id="bt_dyn_max_price" value="{if isset($fPriceMax)}{$fPriceMax|floatval}{else}0{/if}" />
								</div>
							</div>
						</div>
...
{literal}
	<script type="text/javascript">
		// Wait for document ready to ensure all scripts are loaded
		$(document).ready(function() {
			// Check if oGmcPro exists
			if (typeof oGmcPro === 'undefined') {
				console.error('oGmcPro object is not defined. Some functionality may not work properly.');
				// Create a minimal fallback object to prevent errors
				window.oGmcPro = {
					aParamsAutcomplete: {},
					autocomplete: function() { console.log('Autocomplete function called but not available'); },
					form: function() { console.log('Form function called but not available'); },
					initShow: function() { console.log('InitShow function called but not available'); },
					selectAll: function() { return false; },
					deleteProduct: function() { console.log('DeleteProduct function called but not available'); }
				};
			}

			// Check if oGmcProLabel exists
			if (typeof oGmcProLabel === 'undefined') {
				console.error('oGmcProLabel object is not defined. Some functionality may not work properly.');
				// Create a minimal fallback object
				window.oGmcProLabel = {
					initForm: function() { console.log('InitForm function called but not available'); },
					displayClElement: function() { console.log('DisplayClElement function called but not available'); }
				};
			}

			// Define aShow as an empty array
			var aShow = [];
		...
		oGmcProLabel.displayClElement('bt_cl-type', sGmcpLabel);
			...
			// Try to call autocomplete safely
			try {
				...
				console.error('Error calling autocomplete:', e);
			}

			// var for dynamic title - Define this BEFORE using it
			...
			// Try to call initShow safely
			try {
				oGmcPro.initShow(aShow);
			} catch(e) {
				console.error('Error calling initShow:', e);
			}

			// Try to call other functions safely - Make sure we're passing the correct variable
			try {
				// Check if the variable is defined and not empty
				if (typeof sGmcpLabel !== 'undefined' && sGmcpLabel !== '') {
					console.log('Using sGmcpLabel:', sGmcpLabel);
					oGmcProLabel.initForm('bt_cl-type', sGmcpLabel);
					oGmcProLabel.displayClElement('bt_cl-type', sGmcpLabel);
				} else {
					// Use a default value if sGmcpLabel is not defined
					console.warn('sGmcpLabel is not defined, using default value');
					oGmcProLabel.initForm('bt_cl-type', 'Filter:');
					oGmcProLabel.displayClElement('bt_cl-type', 'Filter:');
				}
			} catch(e) {
				console.error('Error calling oGmcProLabel functions:', e);
				console.log('Error details:', e.message);
				// Try with a hardcoded string as fallback
				try {
					oGmcProLabel.initForm('bt_cl-type', 'Filter:');
					oGmcProLabel.displayClElement('bt_cl-type', 'Filter:');
				} catch(e2) {
