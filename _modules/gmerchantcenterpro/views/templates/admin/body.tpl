			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
				...
				<div id="mainMenu" class="list-group workTabs">
					...
					<div id="collapseTwo" class="panel-collapse collapse">
						<a class="list-group-item" id="tab-010" href="#gmcp-management-dropdown1"><i class="submenu fa fa-cogs"></i>&nbsp;{l s='Special offers feed' mod='gmerchantcenterpro'}</a>
						<a class="list-group-item" id="tab-011" href="#gmcp-management-dropdown2"><i class="submenu fa fa-shopping-cart"></i>&nbsp;{l s='Local product inventory feed' mod='gmerchantcenterpro'}</a>
						<a class="list-group-item" id="tab-012" href="#gmcp-management-dropdown3"><i class="submenu fa fa-star"></i>&nbsp;{l s='Product ratings feed' mod='gmerchantcenterpro'}</a>
					</div>
					...
					<div id="collapseFour" class="panel-collapse collapse">
						...
						<a class="list-group-item" id="tab-031" href="#gmcp-management-dropdown2"><i class="submenu fa fa-bookmark-o"></i>&nbsp;{l s='Special offers feed' mod='gmerchantcenterpro'}</a>
						<a class="list-group-item" id="tab-033" href="#gmcp-management-dropdown3"><i class="submenu fa fa-star"></i>&nbsp;{l s='Product ratings feed' mod='gmerchantcenterpro'}</a>
						<a class="list-group-item" id="tab-034" href="#gmcp-management-dropdown4"><i class="submenu fa fa-shopping-cart"></i>&nbsp;{l s='Local product inventory feed' mod='gmerchantcenterpro'}</a>
					...
					<a class="list-group-item pointer" id="tab-6"><span class="icon-random"></span>&nbsp;&nbsp;{l s='Our other modules' mod='gmerchantcenterpro'}</a>
				</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
				...
				<div class="footer">
					...
					<div class="d-flex justify-content-center mt-2 mb-2">
						<a href="{$faqUrl|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/product/68" target="_blank" class="btn btn-faq btn-lg btn-primary w-25"><i class="fa fa-link"></i>&nbsp; {l s='More FAQ\'s' mod='gmerchantcenterpro'}</a>
					</div>
				</div>
			</div>
		</div>
