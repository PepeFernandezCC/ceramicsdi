...
class cartRulesDao
{
     ...
     * @param string $fMinAmount
     * @param string $fValueMin
     * @param string $fValueMax
     * @param string $sTypeExport
     * @param string $sCumulate
     * @param int $feedLangId
     *
