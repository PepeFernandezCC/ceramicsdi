...
require_once dirname(__FILE__) . '/../../ecommerce_common_lib/Commons/Crypto.php';
...
class CorreosRest
{
    ...
    public function getOrderStatus($correos_code, $all, $id_sender = false)
    {
        ...
        try {
            ...
            $correos_user_password['password'] = Crypto::decrypt($correos_user_password['password']);
    ...
    public static function curlExec($url, $username, $password) {
		/* 
		  Se elimina la posible doble barra que pueda venir en la contraseña (después de la función Crypto::decrypt
		*/
