            ...
            <div class="col-sm-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        -->
                            ...
                            && $default_sender.sender_from_time != $default_sender.sender_to_time
                            && !$order_done}
                        ...
                        <div class="input-group mb-3  {if $order_done}hidden-block{/if}" id="input_grabar_recogida_container">
                                <div class="input-group-addon input-group-checkbox-custom">
                                    <input class="form-check-input mt-0" type="checkbox"
                                        ...
                                        id="inputCheckSavePickup" aria-label=""
                                        {if $show_masive_pickup_container}
                                            checked="true" 
                                        {/if}>
                                </div>
                            ...
                            <div id="masive_pickup_container" class="mb-3 {if !$show_masive_pickup_container} hidden-block {/if}">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group input-group-custom pickup-date-container">
                                                ...
                                                <input type="date" id="PickupDateRegister" name="PickupDateRegister"
                                                    ...
                                                    {if strtotime(date('H:i:s')) > strtotime($default_sender.sender_to_time)}
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group input-group-custom" id="">
                                                        ...
                                                        <input type="time" id="PickupFromRegister" name="PickupFromRegister"
                                                            class="form-control"
                                                            value="{$default_sender.sender_from_time|escape:'htmlall':'UTF-8'}">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="input-group input-group-custom" id="">
                                                        ...
                                                        <input type="time" id="PickupToRegister" name="PickupToRegister"
                                                            class="form-control"
                                                            value="{$default_sender.sender_to_time|escape:'htmlall':'UTF-8'}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                -->
                                    ...
                                    <div id="orderAdminPrintLabelPickup" class="input-group my-3 {if $carrier_order.company == 'CEX'} hidden-block {/if}">
                                        <div class="input-group-addon input-group-checkbox-custom">
                                    ...
                                    <div id="orderAdminPackageSize" class="input-group my-3 {if $carrier_order.company == 'CEX'} hidden-block {/if}">
                                        <div class="input-group-addon input-group-text-custom">
                ...
                <div class="{if !$order_done }hidden-block{/if}" id="general-pickup-container">
                    ...
                    <div class="card {if $pickup == 0 }hidden-block{/if}" id="data-pickup-container">
                        ...
                        <div class="card-body">
                            <div
                                class="row {if $pickup == 0 && $carrier_order['company'] == "Correos"}hidden-block{/if}">
                                <div class="col-sm-6">
