                                    ...
                                    <div class="col-sm-7 mt-3">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="input-group input-group-custom" id="input_pos_etiqueta_container_reimpresion_return">
                                                    <div class="input-group-addon input-group-text-custom">
                                                        <label class="input-group-text-bulto">{l s='Label position' mod='correosoficial'}</label>
                                                    </div>
                                                    <select class="form-select select-label-position select-label-position-return" id="input_pos_etiqueta_reimpresion_return" name="input_pos_etiqueta_reimpresion_return" >
                                                ...
                                                <div class="input-group input-group-custom mb-3 {if !$require_customs_doc || $carrier_type == "CEX"}hidden-block{/if} " id="customs-labels-container">
                                                    ...
                                                    </button>                                                    {* <input id="ImprimirDUAButton2" class="btn-sm co_primary_button PrintGestionAduaneraLabels2" type="button" value="{l s='Print DCAF' mod='correosoficial'}">
