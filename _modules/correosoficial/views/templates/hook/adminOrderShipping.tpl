<div class="card">
    ...
    <div class="card-body" id="container_shipping">
        <div id="contentCopied" class="notification-popup hidden-block">{l s='Content copied to clipboard' mod='correosoficial'}</div>
        <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                ...
                <div id="require_customs_doc" class="input-group input-group-custom {if !$require_customs_doc}hidden-block{/if}">
                    <div class="input-group-addon input-group-text-custom">
