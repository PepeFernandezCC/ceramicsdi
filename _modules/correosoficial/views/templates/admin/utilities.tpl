...
<link rel="stylesheet" type="text/css" href="{$co_base_dir}views/css/datatables/dataTables.bootstrap5.min.css" />
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="gestion-tab" data-bs-toggle="tab" data-bs-target="#gestion"
                    type="button" role="tab" aria-controls="gestion"
                    aria-selected="true">{l s='Mass Orders Management' mod='correosoficial'}</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="reimpresion-tab" data-bs-toggle="tab" data-bs-target="#reimpresion"
                    type="button" role="tab" aria-controls="reimpresion"
                    aria-selected="false">{l s='Label Reprint' mod='correosoficial'}</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="generacion-tab" data-bs-toggle="tab" data-bs-target="#generacion"
                    type="button" role="tab" aria-controls="generacion"
                    aria-selected="false">{l s='Order Summary' mod='correosoficial'}</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pickups-tab" data-bs-toggle="tab" data-bs-target="#collected" type="button"
                    role="tab" aria-controls="collected"
                    aria-selected="false">{l s='Pickups' mod='correosoficial'}</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="documentacion-tab" data-bs-toggle="tab" data-bs-target="#documentacion"
                    type="button" role="tab" aria-controls="documentacion"
                    aria-selected="false">{l s='Generation of Customs Documentation' mod='correosoficial'}</button>
            </li>
        </ul>
...
<script>
    ...
    var utilities_token = "{$utilities_token}";
