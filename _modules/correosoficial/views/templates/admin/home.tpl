        ...
        <div class="row left-right-container">
            ...
            <div class="col-md-6 form-col-left">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>
                            <img src="{$co_base_dir}views/img/paq24.png" alt="paq24" width="50" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>
                            <img src="{$co_base_dir}views/img/Entrega_Flexible.png"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>
                            <img src="{$co_base_dir}views/img/localizacion.png" alt="localizacion"
                                width="50" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>
                            <img src="{$co_base_dir}views/img/check.png" alt="check" width="50" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>
                            <img src="{$co_base_dir}views/img/sms.png" alt="sms" width="50" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>
                            <img src="{$co_base_dir}views/img/calendario.png" alt="calendario"
                                width="50" />
