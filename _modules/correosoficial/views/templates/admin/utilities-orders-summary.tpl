         ...
         <div class="col-sm-4 offset-md-4">
             ...
             <form id="searchResumeOrdersForm" name="searchResumeOrdersForm" class="needs-validation" novalidate>
                 <div class="input-group mb-3">
                     ...
                     <input type="date" id="inputFromDateSummary" name="inputFromDateSummary"
                         class="form-control search-utilities-input">
                 </div>
                 <div class="input-group mb-3">
                     <div class="input-group-addon input-group-text-custom">
                         <span
                             class="input-group-text input-group-text-color">{l s='Untill' mod='correosoficial'}</span>
                     </div>
                     <input type="date" id="inputToDateSummary" name="inputToDateSummary"
                         class="form-control search-utilities-input">
                 </div>
                 <div class="input-group mb-3">
                     <span
                         class="input-group-text input-group-text-color">{l s='Search by labeling date' mod='correosoficial'}</span>
                     <div class="input-group-addon input-group-checkbox-custom">
                         <input class="form-check-input mt-0" type="checkbox" id="checkSearchByLabelingDate"
                             name="checkSearchByLabelingDate">
                     </div>
                 </div>
                 <div class="input-group mb-3">
                     <div class="input-group-addon input-group-text-custom">
                         <span
                             class="input-group-text input-group-text-color">{l s='Senders' mod='correosoficial'}</span>
                     </div>
                     <select class="form-select select-label select-label-return" id="inputOrdersSummarySenders"
                         name="inputOrdersSummarySenders">
                         <option value="">{l s='All' mod='correosoficial'}</option>
                 ...
                 <div class="input-group mb-3">
                     <input id="SummarySearchButton" name="SummarySearchButton"
     ...
     <div class="card card-margin card-table-utilities" id="card3">
         ...
         <div id="ordersSummaryTable" class="card-body card-body-custom">
             ...
             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#002e6d"
                 class="bi bi-info-circle-fill" viewBox="0 0 16 16" data-bs-toggle="tooltip" data-bs-placement="right"
             ...
             <div class="showButtonsContainer3 hidden-block">
                 ...
                 <a class="toggle-vis3" data-column="10">{l s='Package code' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="4">{l s='Carrier' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="11">{l s='Customer code' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="5">{l s='Recipient name' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="6">{l s='Shipping address' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="12">{l s='CP' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="7">{l s='Date/Hour recording' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="9">{l s='Labeling date' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="12">{l s='Manifested' mod='correosoficial'}</a>
                 <a class="toggle-vis3" data-column="13">{l s='Manifest date' mod='correosoficial'}</a>


                 <a class="toggle-vis3" data-column="8">{l s='ID shop' mod='correosoficial'}</a>
             </div>
             <table id="ResumenDataTable" class="table table-striped" width="100%">
                 <thead>
                     <tr>
                         <th><input type="checkbox" name="table-select-all-resumen" value="1"
                                 id="table-select-all-resumen"></th>
                         <th>ID</th>
                         ...
                         <th>{l s='Manifest date' mod='correosoficial'}</th>
                         <th>{l s='ID shop' mod='correosoficial'}</th>
                     </tr>
                 </thead>
                 <tfoot>
                    <tr>
                         ...
                         <div class="input-group mb-3">
                             <div class="card">
                                 <div class="card-body" id="button_print">
                                     <button id="ImprimirResumenButton" class="btn-lg co_primary_button center-block"
                                         type="button" value="Imprimir manifiesto de pedidos">
                                         ...
                                         <span class="label-message" role="status" aria-hidden="true">Imprimir
                                             manifiesto de pedidos</span>
                                     </button>
                                 </div>
                             </div>
                         </div>
