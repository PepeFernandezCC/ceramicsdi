<div id="customer-data" class="accordion-body">
            ...
            <div class="card">
                ...
                <div class="card-body card-body-custom">
                    ...
                    <div class="add-new-contract-container">
                        <button id="add-new-contract" type="button" class="btn btn-secondary"><span
                                class="add-new-seder-plus">+ </span>{l s='New count' mod='correosoficial'}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="cocexUserLoggin" class="row justify-content-md-center hidden-block">
        <div id="Correos" class="col-sm-6 col-correos">
            <img src="{$co_base_dir}views/img/logos/correos_ind_blue.png" class="correos-logo" alt="Logo Correos" />
        ...
        <div id="CEX" class="col-sm-6 col-cex">
            <img src="{$co_base_dir}views/img/logos/cex_ind_yellow.png" class="correos-express-logo"
...
<script>
    ...
    var soapFeatureInstallErrorMessage = "{l s='ERROR 12050: To use Correos webservice credentials, you must have the SOAP feature installed. Please contact your hosting for more information' mod='correosoficial'}";
</script>