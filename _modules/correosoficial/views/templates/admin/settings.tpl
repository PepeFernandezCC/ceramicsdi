...
{if $shop_context !== 1}  
    <div class="alert alert-warning" style="font-weight: 700; font-size: 16px; margin:20px 0;">                                    
        {l s='In order to configure the module you must select a store.' mod='correosoficial'}
    </div>
{else}
