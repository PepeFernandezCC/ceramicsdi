...
jQuery("#form_registered").hide();
   ...
   /* Validaciones de campos */
    ...
    }, jQuery.validator.format(wrongDniCif)); /* Literal traducible en home.tpl que mostramos si el DNI/CIF es incorrecto. */
...
jQuery('#privacy_policy').click(function(e){
    ...
    e.preventDefault();
    window.open('https://www.correos.es/es/es/legales/otros/formulario-paqueteria--proteccion-datos',
    "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=0,left=500,width="+width+",height="+height+"");
  });
