...
var LayerSlider = {
	...
	addFormattedLayer: function( el, layerProperties ) {
		...
		jQuery('.ls-overlay.dim').remove();
		jQuery('.ls-layer-types').animate({ marginTop : 40, opacity : 0 }, 150, function() {
			jQuery(this).hide();
		});
...
var LS_ImportLayer = {
	...
	init: function() {
		...
		jQuery(document).on('click', '.ls-import-layer-sliders .slider-item', function() {
			LS_ImportLayer.selectSlider( this );
		});

		jQuery(document).on('click', '.ls-import-layer-slides .slider-item', function() {
			LS_ImportLayer.selectSlide( this );
		});

		jQuery(document).on('click', '.ls-import-layer-layers .layer-item', function() {
	...
	loadSliders: function() {
		...
		jQuery.getJSON( ajaxurl, { action: 'ls_get_mce_sliders' }, function( data ) {
			...
			var $target = jQuery('#tmpl-import-layer-modal-window .ls-import-layer-sliders');
	...
	loadSlides: function( sliderID ) {
		...
		jQuery.getJSON( ajaxurl, { action: 'ls_get_mce_slides', sliderID: sliderID }, function( data ) {
			...
			var $target = jQuery('#tmpl-import-layer-modal-window .ls-import-layer-slides');
	...
	selectSlide: function( item ) {
		...
		var sliderID 	= jQuery('.ls-import-layer-sliders .selected').data('id');
		var slideIndex 	=jQuery('.ls-import-layer-slides .selected').index();

		LS_ImportLayer.loadLayers( sliderID, slideIndex );
	},


	loadLayers: function( sliderID, slideIndex ) {

		jQuery.getJSON( ajaxurl, { action: 'ls_get_mce_layers', sliderID: sliderID, slideIndex: slideIndex }, function( data ) {

			var $holder = jQuery('#tmpl-import-layer-modal-window .ls-import-layer-layers');
			...
			var $target = jQuery('#tmpl-import-layer-modal-window .ls-import-layer-layers table tbody');
...
var initSliderBuilder = function() {
	...
	jQuery('#ls-layers').on('click', '.ls-add-sublayer', function(e) {
		...
		jQuery('.ls-layer-types').show().animate({ marginTop : 15, opacity : 1 }, 150);
		jQuery('<div>', { 'class' : 'ls-overlay dim'}).insertAfter('.ls-layer-types');
	...
	}).on('click', '.ls-overlay.dim', function() {
