            ...
            'form' => [
                ...
                'input' => [
                    ...
                    [
                        ...
                        'desc' => $this->module->l(
                            'Add links to fonts that you would like to preload The module can analyse your website and determine which font must be auto-filled. Using the autofill links feature will override links in the text field.',
                            $this->className
                        ) . ' ' . sprintf(
                    ...
                    [
                        ...
                        'desc' => $this->module->l(
                            'Add links to resources that you would like to preconnect to. The module can analyse your website and determine which font must be auto-filled. Using the autofill links feature will override links in the text field.',
                            $this->className
                        ) . ' ' . sprintf(
                            $this->module->l('Separate each URL by a pipe "%s" without spaces.'),
                            Config::PIPE_SEPARATOR
