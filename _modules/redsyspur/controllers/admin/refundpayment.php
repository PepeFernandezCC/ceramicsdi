...
class RefundPaymentController extends AdminController {
	...
	{   
        ...
        $shippingAlreadyRefunded = filter_var($_POST['shippingAlreadyRefunded'], FILTER_VALIDATE_BOOLEAN);
        ...
        $shipmentPaid = Redsys_Order::checkShipmentPaid($shipmentRefund, $shippingAlreadyRefunded);
