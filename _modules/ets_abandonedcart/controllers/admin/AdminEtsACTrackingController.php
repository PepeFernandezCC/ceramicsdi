...
class AdminEtsACTrackingController extends AdminEtsACFormController
{
    ...
    public function __construct()
    {
        ...
        $this->_select = ' 
            ...
            IF(a.read=1,\'read\', IF(a.delivered=1, \'delivered\', \'timeout\')) execute_status,
            acl.`name`,
        ...
        $this->_where = 'AND a.deleted = 0 AND ac.deleted = 0 AND ar.deleted = 0 AND a.total_execute_times > 0';
    ...
    {
        return EtsAbancartTracking::getDiscountCode($id_ets_abancart_tracking);
    }
