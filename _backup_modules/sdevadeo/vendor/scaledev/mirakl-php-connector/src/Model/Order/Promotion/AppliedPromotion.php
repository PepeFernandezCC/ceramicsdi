...
namespace Scaledev\MiraklPhpConnector\Model\Order\Promotion;

use Scaledev\MiraklPhpConnector\Core\Model\AbstractModel;
use Scaledev\MiraklPhpConnector\Model\Order\Promotion\AppliedPromotion\Configuration;
 ...
 */
final class AppliedPromotion extends AbstractModel
{
    /**
     * @var boolean
     */
