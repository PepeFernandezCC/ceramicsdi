...
use Scaledev\MiraklPhpConnector\Response\Order\AcceptOrderResponse;
 ...
 */
final class AcceptOrderRequest extends AbstractRequest
{
    /**
     * Defines the response class to use.
     */
    const RESPONSE_CLASS = AcceptOrderResponse::class;
