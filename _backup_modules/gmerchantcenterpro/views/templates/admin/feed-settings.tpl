		...
		{if !empty($sDisplay) && $sDisplay == 'advanced'}
			...
			<div class="form-group">
				...
				<div class="col-xs-12 col-md-5 col-lg-6">
					...
					&nbsp;&nbsp;
					<a class="badge badge-info" href="{$faqUrl|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/232" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='FAQ about energy efficiency class tags' mod='gmerchantcenterpro'}</a>
				</div>
			</div>
