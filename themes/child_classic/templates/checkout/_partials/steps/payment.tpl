...
{block name='step_content'}
    ...
    <div class="row" style="margin-bottom: 15px;">
        <div class="col-md-12">
            {* PLANATEC *}
            <h4 class="h4 black" style="text-transform: uppercase;">{l s='Payment method' d='Shop.Theme.Checkout'}</h4>
            <span class="small">{l s='Please check your order before payment' d='Shop.Theme.Checkout'}</span>
            {* END PLANATEC *}
        </div>
    </div>
