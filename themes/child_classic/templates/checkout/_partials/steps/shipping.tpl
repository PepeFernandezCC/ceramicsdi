                        ...
                        <div class="delivery-weight">
                            <div class="row">
                                <div class="col-sm-12" style="text-align: left">
                                    <i class="fa fa-info-circle"></i>&nbsp;{l s='Estimated weight of your order' d='Shop.Theme.Checkout'}
                                    &nbsp;
                                    <span style="font-weight: bold;">{Context::getContext()->cart->getTotalWeight()|string_format:"%.2f"|replace:'.':','} {Configuration::get('PS_WEIGHT_UNIT')}</span>
                                </div>
                            </div>
                        </div>
                        {* END PLANATEC *}
