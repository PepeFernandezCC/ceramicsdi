...
{block name='cart_summary_product_line'}
    ...
    {/if}
    <div class="product-line-grid" style="border-bottom: 1px solid #00000096 !important">
        ...
        <div class="product-line-grid-right {if $product.total_wt == 0}product-muestra{/if} product-line-actions">
            <div class="row summary-width" style="display: flex;">
                <div class="col-md-8 col-xs-12 product-line-grid-right-left">
                    ...
                    <div class="row" {if $esMuestra}style="display: none;"{/if}>
                        <div class="col-xs-8">
                            <div class="row">
                                <div class="col-xs-12">
                                    <span class="label">{l s='Boxes' d='Shop.Theme.Catalog'}:&nbsp;{$product.quantity}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-xs-12 product-line-grid-right-right">
                    <div class="price">
