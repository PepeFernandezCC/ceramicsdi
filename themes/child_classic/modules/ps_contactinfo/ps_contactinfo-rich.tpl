...
<div class="contact-rich">
    ...
    <div class="block row" style="margin-top: 30px;margin-bottom:30px">
        ...
        <div class="data col-md-11">
            ...
            <div class="row">     
                <div class="col-md-6">{l s='From Monday to Thursday' d='Shop.Theme.Global'}:</div>
                <div class="col-md-6">{l s='From 8:30 to 14:00' d='Shop.Theme.Global'}<br />{l s='de 15:00 a 17:00' d='Shop.Theme.Global'}</div>
            </div>

            <div class="row" style="padding-top: 10px">
                <div class="col-md-6">{l s='Friday' d='Shop.Theme.Global'}:</div>
                <div class="col-md-6">{l s='From 8:30 to 14:00' d='Shop.Theme.Global'}</div>
            </div>
