...
{/block}
{block name="content"}
    <div class="container container-single-blog">
        <div class="row">
            ...
            <div id="content-wrapper"
                ...
                {/if}
                    <div class="ybc_blog_layout_{$blog_layout|escape:'html':'UTF-8'} ybc-blog-wrapper-detail" itemscope
                        ...
                        <div itemprop="publisher" itemtype="http://schema.org/Organization" itemscope="">
                            ...
                            {if Configuration::get('PS_LOGO')}
                                <div itemprop="logo" itemscope itemtype="http://schema.org/ImageObject">
                                    <meta itemprop="url"
                                          content="{$blog_config.YBC_BLOG_SHOP_URI|escape:'html':'UTF-8'}img/{Configuration::get('PS_LOGO')|escape:'html':'UTF-8'}"/>
                                ...
                                <div class="post-details">
                                    <div class="blog-extra">
                                        <div class="ybc-blog-latest-toolbar">
                                            {if $show_views}
                                                <span title="{l s='Page views' mod='ybc_blog'}"
...
{else}
                                            ...
                                            {/if}
                                            {if $allow_like}
                                                <span title="{if $likedPost}{l s='Unlike this post' mod='ybc_blog'}{else}{l s='Like this post' mod='ybc_blog'}{/if}"
                                                      class="ybc-blog-like-span ybc-blog-like-span-{$blog_post.id_post|intval}{if $likedPost} active{/if}"
                                                      data-id-post="{$blog_post.id_post|intval}">
                                    ...
                                    <span class="blog-post-like-text blog-post-like-text-{$blog_post.id_post|intval}"><span>{l s='Liked' mod='ybc_blog'}</span></span>
                                            ...
                                            {if $allow_rating && $everage_rating}
                                                <div class="blog_rating_wrapper">
                                                    {if $total_review}
                                                        <span title="{l s='Comments' mod='ybc_blog'}"
                                             ...
                                             <span>
                                                ...
                                                {/if}
                                                    ...
                                                    {/if}
                                                    <div title="{l s='Average rating' mod='ybc_blog'}"
                                            ...
                                            {if $show_author && isset($blog_post.employee) &&  $blog_post.employee}
                                                <div class="author-block" itemprop="author" itemscope
                                                     itemtype="http://schema.org/Person">
                                                    <span class="post-author-label">{l s='By ' mod='ybc_blog'}</span>
                                                    <a itemprop="url"
                                                       href="{$blog_post.author_link|escape:'html':'UTF-8'}">
                                        <span class="post-author-name" itemprop="name">
                                            ...
                                            {if isset($blog_post.link_edit) && $blog_post.link_edit}
                                                <a class="ybc-block-post-edit"
                                                   href="{$blog_post.link_edit|escape:'html':'UTF-8'}"
                                                   title="{l s='Edit' mod='ybc_blog'}"><i class="fa fa-pencil"
                                                                                          aria-hidden="true"></i>&nbsp;{l s='Edit' mod='ybc_blog'}
                                                </a>
                                            {/if}
                                                    ...
                                                    <ul>
                                                        {if $use_facebook_share}
                                                            <li class="facebook icon-gray">
                                                                <a target="_blank" title="{l s='Share' mod='ybc_blog'}"
                                                                   class="text-hide"
                                                                   href="http://www.facebook.com/sharer.php?u={$post_url|escape:'html':'UTF-8'}">{l s='Share' mod='ybc_blog'}</a>
                                                            </li>
                                                        {/if}
                                                        {if $use_twitter_share}
                                                            <li class="twitter icon-gray">
                                                                <a target="_blank"
                                                                   title="{l s='Twitter' mod='ybc_blog'}"
                                                                   class="text-hide"
                                                                   href="https://twitter.com/intent/tweet?text={$blog_post.title|escape:'html':'UTF-8'} {$post_url|escape:'html':'UTF-8'}">{l s='Twitter' mod='ybc_blog'}</a>
                                                            </li>
                                                        {/if}
                                                        {if $blog_config.YBC_BLOG_ENABLE_PINTEREST_SHARE}
                                                            <li class="pinterest icon-gray">
                                                                <a target="_blank"
                                                                   title="{l s='Pinterest' mod='ybc_blog'}"
                                                                   class="text-hide"
                                                                   href="http://www.pinterest.com/pin/create/button/?media={$blog_post.image|escape:'html':'UTF-8'}&url={$post_url|escape:'html':'UTF-8'}">{l s='Pinterest' mod='ybc_blog'}</a>
                                                            </li>
                                                        {/if}
                                                        {if $blog_config.YBC_BLOG_ENABLE_LIKED_SHARE}
                                                            <li class="linkedin icon-gray">
                                                                <a target="_blank"
                                                                   title="{l s='LinkedIn' mod='ybc_blog'}"
                                                                   class="text-hide"
                                                                   href="https://www.linkedin.com/shareArticle?mini=true&url={$post_url|escape:'html':'UTF-8'}&title={$blog_post.title|escape:'html':'UTF-8'}&summary={$blog_post.short_description|strip_tags:'UTF-8'|truncate:500|escape:'html':'UTF-8'}&source=LinkedIn">{l s='LinkedIn' mod='ybc_blog'}</a>
                                                            </li>
                                                        {/if}
                                                        {if $blog_config.YBC_BLOG_ENABLE_TUMBLR_SHARE}
                                                            <li class="tumblr icon-gray">
                                                                <a target="_blank" title="{l s='Tumblr' mod='ybc_blog'}"
                                                                   class="text-hide"
                                                                   href="http://www.tumblr.com/share/link?url={$post_url|escape:'html':'UTF-8'}">{l s='Tumblr' mod='ybc_blog'}</a>
                                                            </li>
                                                        {/if}
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="form-polls">
                                                <div class="form-group polls-title noactive">
                                                    ...
                                                    <label for="polls_post_1"
                                                           {if $polls_class && $polls_class->polls==1}class="disabled"{/if}>
                                                        <i class="fa fa-thumbs-o-up"></i> {l s='Yes' mod='ybc_blog'}
                                                        <span
                                                                id="polls_post_helpful_yes">({$polls_post_helpful_yes|intval})</span>
                                                        <input id="polls_post_1" type="radio" name="polls_post"
                                                               value="1"
                                                               {if $polls_class && $polls_class->polls==1}disabled="disabled"{/if}/>
                                                    </label>
                                                    <label for="polls_post_0"
                                                           {if $polls_class && $polls_class->polls==0}class="disabled"{/if}>
                                                        <i class="fa fa-thumbs-o-down"></i> {l s='No' mod='ybc_blog'}
                                                        <span
                                                                id="polls_post_helpful_no">({$polls_post_helpful_no|intval})</span>
                                                        <input id="polls_post_0" type="radio" name="polls_post"
                                                               value="0"
                                                               {if $polls_class && $polls_class->polls==0}disabled="disabled"{/if}/>
                                                    </label>
                                                </div>
                                                <div class="form-polls-body hidden">
                                                    <div class="form-group polls-name">
                                                        <input name="polls_name" id="polls_name"
                                                               placeholder="{l s='Your name' mod='ybc_blog'}"
                                                               value="{if $polls_customer}{$polls_customer->lastname|escape:'html':'UTF-8'} {$polls_customer->firstname|escape:'html':'UTF-8'}{/if}"
                                                               {if $polls_customer}readonly="true"{/if}/>
                                                    </div>
                                                    <div class="form-group polls-email">
                                                        <input name="polls_email" id="polls_email"
                                                               placeholder="{l s='Your email' mod='ybc_blog'}"
                                                               {if $polls_customer}readonly="true"{/if}
                                                               value="{if $polls_customer}{$polls_customer->email|escape:'html':'UTF-8'}{/if}"/>
                                                    </div>
                                                    <div class="form-group polls-feedback">
                                                    <textarea name="polls_feedback" id="polls_feedback"
                                                              placeholder="{l s='Please leave us your feedback' mod='ybc_blog'}"></textarea>
                                                    </div>
                                               ...
                                               <span class="poll-capcha-wrapper">
                                                    <img rel="{$blog_poll_random_code|escape:'html':'UTF-8'}"
                                                         class="ybc-captcha-img-data" id="ybc-blog-polls-capcha-img"
                                                         src="{$polls_capcha_image|escape:'html':'UTF-8'}"
                                                         alt="{l s='Security code' mod='ybc_blog'}"/>
                                                    <input placeholder="{l s='Secure code' mod='ybc_blog'}"
                                                           class="form-control" name="polls_capcha_code" type="text"
                                                           id="polls-capcha" value=""/>
                                                    <span id="ybc-blog-polls-capcha-refesh"
                                                          title="{l s='Refresh code' mod='ybc_blog'}"></span>
                                                </span>
                                                            </div>
                                                        {else}
                                                        {if $blog_config.YBC_BLOG_CAPTCHA_TYPE=='google'}
                                                            <script src="https://www.google.com/recaptcha/api.js?onload=ybc_polls_lonloadCallback&render=explicit"
                                                                    async defer></script>
                                                            <div id="ybc_blog_polls_g_recaptcha"
                                                                 class="ybc_blog_g_recaptcha"></div>
                                                        {/if}
                                                        {if $blog_config.YBC_BLOG_CAPTCHA_TYPE=='google3'}
                                                        <input type="hidden" id="ybc_blog_polls_g_recaptcha"
                                                    ...
                                                    <div class="form_action_footer">
                                                        ...
                                                        <button type="submit"
                                                                name="polls_submit">{l s='Submit' mod='ybc_blog'}</button>
                                                        <button type="button" name="polls_cancel"
                                                                style="margin-right: 10px;">{l s='Cancel' mod='ybc_blog'}</button>
                                                    </div>
                                    ...
                                    {else}{l s='Tag' mod='ybc_blog'}{/if}:
                                                    ...
                                                    {foreach from=$blog_post.tags item='tag'}
                                                        {assign var='ik' value=$ik+1}
                                                        <a
                                                        href="{$tag.link|escape:'html':'UTF-8'}">{ucfirst($tag.tag)|escape:'html':'UTF-8'}</a>{if $ik < $totalTag}, {/if}
                                                    {/foreach}
                                                </div>
                                            {/if}
                                        </div>
                                    ...
                                    {if isset($blog_config.YBC_BLOG_AUTHOR_INFORMATION)&& $blog_config.YBC_BLOG_AUTHOR_INFORMATION && isset($blog_post.employee.description)&& $blog_post.employee.description}
                                        <div class="ybc-block-author ybc-block-author-avata {if $blog_post.employee.avata} ybc-block-author-avata{/if}">
                                            {if $blog_post.employee.avata}
                                                <div class="avata_img">
                                                    <img class="avata"
                                                         src="{$link->getMediaLink("`$smarty.const._PS_YBC_BLOG_IMG_`avata/`$blog_post.employee.avata|escape:'htmlall':'UTF-8'`")}"/>
                                                </div>
                                            {/if}
                                            <div class="ybc-des-and-author">
                                                <div class="ybc-author-name">
                                                    <a href="{$blog_post.author_link|escape:'html':'UTF-8'}">
                                                        {l s='Author' mod='ybc_blog'}
                                                        : {$blog_post.employee.name|escape:'html':'UTF-8'}
                                                    </a>
                                                </div>
                                                                ...
                                                                <div class="left-block">
                                                                    <a class="ybc_item_img{if isset($blog_config.YBC_BLOG_LAZY_LOAD)&& $blog_config.YBC_BLOG_LAZY_LOAD} ybc_item_img_ladyload{/if}"
                                                                       href="{$product.link|escape:'html':'UTF-8'}">
                                                                        <img src="{if isset($blog_config.YBC_BLOG_LAZY_LOAD) && $blog_config.YBC_BLOG_LAZY_LOAD}{$link->getMediaLink("`$smarty.const._MODULE_DIR_`ybc_blog/views/img/bg-grey.png")|escape:'html':'UTF-8'}{else}{$product.img_url|escape:'html':'UTF-8'}{/if}"
                                                                             alt="{$product.name|escape:'html':'UTF-8'}" {if isset($blog_config.YBC_BLOG_LAZY_LOAD)&& $blog_config.YBC_BLOG_LAZY_LOAD} data-original="{$product.img_url|escape:'html':'UTF-8'}" data-src="{$product.img_url|escape:'html':'UTF-8'}" class="lazyload"{/if} />
                                                                        ...
                                                                        <div class="blog-product-extra content_price">
                                                                            {if $product.price!=$product.old_price}
                                                                                <span class="bp-price-old old-price"><span
                                                                                            class="bp-price-old-label">{l s='Old price: ' mod='ybc_blog'}</span><span
                                                                                            class="bp-price-old-display">{$product.old_price|escape:'html':'UTF-8'}</span></span>
                                                                            {/if}
                                                                            <span class="bp-price price product-price"><span
                                                                                        class="bp-price-label">{l s='Price:  ' mod='ybc_blog'}</span><span
                                                                                        class="bp-price-display"
                                                                                        itemprop="price"
                                                                                        content="{$product.price|escape:'html':'UTF-8'}">{$product.price|escape:'html':'UTF-8'}</span></span>
                                                                            {if $product.price!=$product.old_price}
                                                                                <span class="bp-percent price-percent-reduction"><span
                                                                                            class="bp-percent-label">{l s='Discount: ' mod='ybc_blog'}</span><span
                                                                                            class="bp-percent-display">{$product.discount_percent|escape:'html':'UTF-8'}{l s='%' mod='ybc_blog'}</span></span>
                                                                                <span class="bp-save"><span
                                                                                            class="bp-save-label">{l s='Save up: ' mod='ybc_blog'}</span><span
                                                                                            class="bp-save-display">-{$product.discount_amount|escape:'html':'UTF-8'}</span></span>
                                                                            {/if}
                                                                        </div>
                                                                    {/if}
                                        ...
                                        {if $allowComments}
                                            {if $allowComments==2}
                                                ...
                                                <script async defer crossorigin="anonymous"
                                                        src="https://connect.facebook.net/{$langLocale|escape:'html':'UTF-8'}/sdk.js#xfbml=1&version=v8.0"
                                                        nonce="xHtLYTmH"></script>
                                                <h4 class="title_blog">{l s='Facebook comment' mod='ybc_blog'}</h4>
                                                <div class="fb-comments" data-width="760"
                                                     data-href="{$post_url|escape:'html':'UTF-8'}" data-numposts="5"
                                                     data-width=""></div>
                                            {else}
                                                        ...
                                                        {if $hasLoggedIn || $allowGuestsComments}
                                                            <form action="#ybc-blog-form-comment" method="post">
                                                                {if isset($comment_edit->id) && $comment_edit->id && !$justAdded}
                                                                    <input type="hidden"
                                                                           value="{$comment_edit->id|intval}"
                                                                           name="id_comment"/>
                                                                {/if}
                                                                {if !$hasLoggedIn}
                                                                    <div class="blog-comment-row blog-name">
                                                                        <label for="bc-name">{l s='Name' mod='ybc_blog'}</label>
                                                                        <input class="form-control" name="name_customer"
                                                                               id="bc-name" type="text"
                                                                               value="{if isset($name_customer)}{$name_customer|escape:'html':'UTF-8'}{elseif isset($comment_edit->name) && !$justAdded}{$comment_edit->name|escape:'html':'UTF-8'}{/if}"/>
                                                                    </div>
                                                                    <div class="blog-comment-row blog-email">
                                                                        <label for="bc-email">{l s='Email' mod='ybc_blog'}</label>
                                                                        <input class="form-control"
                                                                               name="email_customer"
                                                                               id="bc-email" type="text"
                                                                               value="{if isset($email_customer)}{$email_customer|escape:'html':'UTF-8'}{elseif isset($comment_edit->email)&& !$justAdded}{$comment_edit->email|escape:'html':'UTF-8'}{/if}"/>
                                                                    </div>
                                                                {/if}
                                                                <div class="blog-comment-row blog-title">
                                                                    <label for="bc-subject">{l s='Subject ' mod='ybc_blog'}</label>
                                                                    <input class="form-control" name="subject"
                                                                           id="bc-subject" type="text"
                                                                           value="{if isset($subject)}{$subject|escape:'html':'UTF-8'}{elseif isset($comment_edit->subject)&& !$justAdded}{$comment_edit->subject|escape:'html':'UTF-8'}{/if}"/>
                                                                </div>
                                                                <div class="blog-comment-row blog-content-comment">
                                                                    <label for="bc-comment">{l s='Comment ' mod='ybc_blog'}</label>
                                                                    <textarea class="form-control" name="comment"
                                                                              id="bc-comment">{if isset($comment)}{$comment|escape:'html':'UTF-8'}{elseif isset($comment_edit->comment)&& !$justAdded}{$comment_edit->comment|escape:'html':'UTF-8'}{/if}</textarea>
                                                                </div>
                                                                <div class="blog-comment-row flex_space_between flex-bottom">
                                                                    {if $allow_rating || $use_capcha}
                                                                                ...
                                                                                <div class="blog-rate-post">
                                                                                    ...
                                                                                    <div class="blog_rating_box">
                                                                                        {if $default_rating > 0 && $default_rating <5}
                                                                                            <input id="blog_rating"
                                                                                                   type="hidden"
                                                                                                   name="rating"
                                                                                                   value="{$default_rating|intval}"/>
                                                                                            {for $i = 1 to $default_rating}
                                                                                                <div rel="{$i|intval}"
                                                                                                     class="star star_on blog_rating_star blog_rating_star_{$i|intval}"></div>
                                                                                            {/for}
                                                                                            {for $i = $default_rating + 1 to 5}
                                                                                                <div rel="{$i|intval}"
                                                                                                     class="star blog_rating_star blog_rating_star_{$i|intval}"></div>
                                                                                            {/for}
                                                                                        {else}
                                                                                            <input id="blog_rating"
                                                                                                   type="hidden"
                                                                        ...
                                                                        <img rel="{$blog_random_code|escape:'html':'UTF-8'}"
                                                                             class="ybc-captcha-img-data"
                                                                             id="ybc-blog-capcha-img"
                                                                             src="{$capcha_image|escape:'html':'UTF-8'}"
                                                                             alt="{l s='Security code' mod='ybc_blog'}"/>
                                                                        <input class="form-control" name="capcha_code"
                                                                               type="text" id="bc-capcha" value=""/>
                                                                        <span id="ybc-blog-capcha-refesh"
                                                                              title="{l s='Refresh code' mod='ybc_blog'}"></span>
                                                                                ...
                                                                                {else}
                                                                                {if $blog_config.YBC_BLOG_CAPTCHA_TYPE=='google'}
                                                                                    <script src="https://www.google.com/recaptcha/api.js?onload=ybc_comment_lonloadCallback&render=explicit"
                                                                                            async defer></script>
                                                                                    <div id="ybc_blog_comment_g_recaptcha"
                                                                                         class="ybc_blog_g_recaptcha"></div>
                                                                                {/if}
                                                                                {if $blog_config.YBC_BLOG_CAPTCHA_TYPE=='google3'}
                                                                                <input type="hidden"
                                                                                       id="ybc_blog_comment_g_recaptcha"
                                                                                       name="g-recaptcha-response"/>
                                                                                    <script type="text/javascript">
                                                                        ...
                                                                        {if !Configuration::get('YBC_BLOG_DISPLAY_GDPR_NOTIFICATION')}
                                                                            <div class="blog-submit">
                                                                                <input class="button" type="submit"
                                                                                       value="{l s='Submit Comment' mod='ybc_blog'}"
                                                                                       name="bcsubmit"/>
                                                                            </div>
                                                                        {/if}
                                                                    </div>
                                                                    ...
                                                                    <div class="blog-submit-form">
                                                                        {if Configuration::get('YBC_BLOG_DISPLAY_GDPR_NOTIFICATION')}
                                                                            <label for="check_gpdr">
                                                                                <input id="check_gpdr" type="checkbox"
                                                                                       type="check_gpdr"
                                                                                       value="1"/>&nbsp;{$text_gdpr|escape:'html':'UTF-8'}
                                                ...
                                                <div class="ybc_blog-comments-list">
                                                    ...
                                                    <ul id="blog-comments-list" class="blog-comments-list">
                                                        {foreach from=$comments item='comment'}
                                                            <li id="blog_comment_line_{$comment.id_comment|intval}"
                                                                class="blog-comment-line">
                                                                <div class="ybc-blog-detail-comment">
                                                                    <h5 class="comment-subject">{$comment.subject|escape:'html':'UTF-8'}</h5>
                                                                    {if $comment.name}<span
                                                                            class="comment-by">{l s='By: ' mod='ybc_blog'}
                                                                        <b>{ucfirst($comment.name)|escape:'html':'UTF-8'}</b>
                                                                        </span>{/if}
                                                                    ...
                                                                    <div class="ybc-block-report-reply-edit-delete">
                                                                        {if $allow_report_comment}
                                                                            {if !($reportedComments && is_array($reportedComments) && in_array($comment.id_comment, $reportedComments))}
                                                                                <span class="ybc-block-comment-report comment-report-{$comment.id_comment|intval}"
                                                                                      rel="{$comment.id_comment|intval}"><i
                                                                                            class="fa fa-bolt"
                                                                                            aria-hidden="true"
                                                                                            title="{l s='Report this comment as abused' mod='ybc_blog'}"></i></span>
                                                                            {/if}
                                                                        {/if}
                                                                        {if isset($comment.reply) && $comment.reply}
                                                                            <span class="ybc-block-comment-reply comment-reply-{$comment.id_comment|intval}"
                                                                                  rel="{$comment.id_comment|intval}"><i
                                                                                        class="fa fa-reply"
                                                                                        aria-hidden="true"
                                                                                        title="{l s='Reply' mod='ybc_blog'}"></i></span>
                                                                        {/if}
                                                                        {if isset($comment.url_edit)}
                                                                            <a class="ybc-block-comment-edit comment-edit-{$comment.id_comment|intval}"
                                                                               href="{$comment.url_edit|escape:'html':'UTF-8'}"><i
                                                                                        class="fa fa-pencil"
                                                                                        aria-hidden="true"
                                                                                        title="{l s='Edit this comment' mod='ybc_blog'}"></i></a>
                                                                        {/if}
                                                                        {if isset($comment.url_delete)}
                                                                            <a class="ybc-block-comment-delete delete-edit-{$comment.id_comment|intval}"
                                                                               href="{$comment.url_delete|escape:'html':'UTF-8'}"><i
                                                                                        class="fa fa-trash"
                                                                                        aria-hidden="true"
                                                                                        title="{l s='Delete this comment' mod='ybc_blog'}"></i></a>
                                                                        {/if}
                                                                    </div>
                                                                    {if $comment.comment}<p
                                                                            class="comment-content">{$comment.comment nofilter}</p>{/if}
                                                                    {if $comment.replies}
                                                                    ...
                                                                    {if isset($replyCommentsave) && $replyCommentsave==$comment.id_comment}
                                                                        {if isset($replyCommentsaveok) && $blog_success}
                                                                            <p class="alert alert-success ybc_alert-success">
                                                                                <button class="close" type="button"
                                                                                        data-dismiss="alert">×
                                                                                </button>{$blog_success|escape:'html':'UTF-8'}
                                                                            </p>
                                                                        {else}
                                                                            {if isset($comment.reply) && $comment.reply}
                                                                                <form class="form_reply_comment"
                                                                                      action="#blog_comment_line_{$comment.id_comment|intval}"
                                                                                      method="post">
                                                                                    {if $blog_errors && is_array($blog_errors) && isset($replyCommentsave)}
                                                                                        <div class="alert alert-danger ybc_alert-danger">
                                                                                            <button class="close"
                                                                                    ...
                                                                                    {/if}
                                                                                    <input type="hidden"
                                                                                           name="replyCommentsave"
                                                                                           value="{$comment.id_comment|intval}"/>
                                                                                    <textarea name="reply_comment_text"
                                                                                              placeholder="{l s='Enter your message...' mod='ybc_blog'}">{$reply_comment_text nofilter}</textarea>
                                                    ...
                                                    {if isset($link_view_all_comment)}
                                                        <div class="blog_view_all_button">
                                                            <a href="{$link_view_all_comment|escape:'html':'UTF-8'}"
                                                               class="view_all_link">{l s='View all comments' mod='ybc_blog'}</a>
                                                        </div>
                                                    {/if}
                                                </div>
                                            {/if}
    ...
    {if $blog_post.related_posts}
        <div class="ybc-blog-related-posts ybc_blog_related_posts_type_{if $blog_related_posts_type}{$blog_related_posts_type|escape:'html':'UTF-8'}{else}default{/if}">
            <p class="title_blog" style="font-weight: bold;">{l s='Related posts' mod='ybc_blog'}</p>
                    ...
                    {foreach from=$blog_post.related_posts item='rpost'}
                        <li class="ybc-blog-related-posts-list-li col-xs-12 col-sm-4 col-lg-{12/$post_row|intval} thumbnail-container">
                            ...
                            <div class="post-date-time">
                                <span>{date($date_format,strtotime($rpost.datetime_added))|escape:'html':'UTF-8'}</span>
                                <meta itemprop="datePublished"
                                      content="{date('Y-m-d',strtotime($rpost.datetime_added))|escape:'html':'UTF-8'}"/>
                                <meta itemprop="dateModified"
...
{else}
                                    ...
                                    {/if}
                                    {if $allow_like}
                                        <span class="ybc-blog-like-span ybc-blog-like-span-{$rpost.id_post|intval} {if isset($rpost.liked) && $rpost.liked}active{/if}"
                                              data-id-post="{$rpost.id_post|intval}">
