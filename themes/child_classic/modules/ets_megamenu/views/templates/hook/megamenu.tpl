...
{if $menusHTML}
        ...
        <div id="menu-ceramic" class="ets_mm_megamenu
            ...
            <div class="ets_mm_megamenu_content">
                ...
                <div class="container-fluid" style="padding: 0;">
                    ...
                    <div class="ets_mm_megamenu_content_content">
                        ...
                        <div class="ybc-menu-toggle ybc-menu-btn closed">
                            ...
                            <span class="ybc-menu-button-toggle_icon">
                                ...
                                <div style="padding-top: 5px">
                                    <i class="fa-solid fa-slash fa-rotate-by" style="position:absolute; --fa-rotate-angle: 98deg;"></i>
                                    <i class="fa-solid fa-slash fa-rotate-by" style="--fa-rotate-angle: 5deg;"></i>
                                </div>
                        ...
                        <div id="menu-desktop-list" class="hidden-sm-down mm-front-view" style="width: 100%;">
        ...
        <div id="menu-mobile-list" class="custom-menu-ult">
