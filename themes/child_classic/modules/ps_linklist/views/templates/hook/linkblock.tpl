 ...
 *}
<div class="{* PLANATEC *}col-md-3{* END PLANATEC *} links">
    <div class="row">
        {foreach $linkBlocks as $linkBlock}
            <div class="{* PLANATEC *}col-md-12{* END PLANATEC *} wrapper">
                <p class="{* PLANATEC *}h4{* END PLANATEC *} hidden-sm-down">{$linkBlock.title}</p>
