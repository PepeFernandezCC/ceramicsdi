...
namespace Scaledev\MiraklPhpConnector\Field\Platform\GetLogisticClassList;
...
/**
 * Class LogisticClassField
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class LogisticClassField extends AbstractField
{
    /**
     * @inheritdoc
     */
     ...
     * @inheritdoc
     */
    const TYPE = LogisticClassCollection::class;
