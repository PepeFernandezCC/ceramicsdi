...
use Scaledev\MiraklPhpConnector\Field\Shop\GetShopInformation\TaxCollection\CodeField;
use Scaledev\MiraklPhpConnector\Field\Shop\GetShopInformation\TaxCollection\LabelField;
use Scaledev\MiraklPhpConnector\Validator\Type\ArrayTypeValidator;

/**
 * Class ApplicableTaxesField
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class ApplicableTaxesField extends AbstractField
{
    /**
     * @inheritdoc
     */
     ...
     * @inheritdoc
     */
    const TYPE = TaxCollection::class;
