...
use Scaledev\MiraklPhpConnector\Response\Product\GetOperatorValueListResponse;

/**
 * Class GetOperatorValueListRequest
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class GetOperatorValueListRequest extends AbstractRequest
{
    /**
     * Defines the response class to use.
     */
    const RESPONSE_CLASS = GetOperatorValueListResponse::class;
    ...
    protected function initResponse()
    {
        ...
        $this->setResponse(
            new $responseClassName(
                json_decode($this->clientResult, 1)['values_lists']
            )
        );
