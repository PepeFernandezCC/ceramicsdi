...
/**
 * Class GetCarriersListRequest
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class GetCarrierListRequest extends AbstractRequest
{
    /**
     * Defines the response class to use.
     */
    const RESPONSE_CLASS = GetCarrierListResponse::class;
    ...
    protected function initResponse()
    {
        ...
        $this->setResponse(
            new $responseClassName(
                json_decode($this->clientResult,1)['carriers']
            )
        );
