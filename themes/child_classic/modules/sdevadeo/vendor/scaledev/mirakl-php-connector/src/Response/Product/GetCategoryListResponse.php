...
use Scaledev\MiraklPhpConnector\Builder\Product\GetCategoryListBuilder;
 ...
 */
final class GetCategoryListResponse extends AbstractResponse
{
    /**
     * Defines the builder class to use.
     */
    const BUILDER_CLASS = GetCategoryListBuilder::class;
