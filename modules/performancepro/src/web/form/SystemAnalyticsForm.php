...
final class SystemAnalyticsForm extends AbstractForm
{
    ...
    public function getFields(): array
    {
        ...
        $prestaShopVersionProvider = [
            sprintf(
                $this->module->l(
                    'PrestaShop version (%s). It is recommended to upgrade the store to the latest PrestaShop as new versions include performance improvements and security fixes.',
                    $this->className
                ),
                _PS_VERSION_
            ),
        ...
        $devMode = [
            $this->module->l(
                'Debug mode. Once your webshop is in production, you must disable the debug mode to increase the performance.',
                $this->className
            ),
            !_PS_MODE_DEV_,
            View::displayBtnAjax(
        ...
        $devProfiling = [
            $this->module->l(
                'Debug profiling. Once your webshop is in production, you must disable the debug profiling to increase the performance.',
                $this->className
            ),
        ...
        return [
            'form' => [
                ...
                'description' => $this->module->l(
                    'Scans the settings of your webshop and recommend options for better performance.',
                    $this->className
                ),
                'input' => [
                    [
