...
final class ClearCartRuleTableCommand implements Command
{
    /**
     * @var DatabaseCleaner
     */
    ...
    {
        $range = CommandUserConfig::getRangeByKey('PP_CART_RULE_TABLE_CLEANER');

        $amount = $this->databaseCleaner->cleanRuleTable($range);
