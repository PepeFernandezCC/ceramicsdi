...
<head>
    ...
    $(window).load(function()
    {
        ...
        function loadPageData(pagenumber, delfilename)
        {
            ...
            if (delfilename!="")
            {
                ...
                ajaxurl = "<?php echo $link->getAdminLink('AdminLayerSliderMedia'); ?>&action=listImages&d="+window.parent.imgpath+"&p="+pagenumber+"&del="+encodeURIComponent(delfilename);
            }
            else
            {
                // else just get the page
                ajaxurl = "<?php echo $link->getAdminLink('AdminLayerSliderMedia'); ?>&action=listImages&d="+window.parent.imgpath+"&p="+pagenumber;
            }
            ...
            {
                // then the number of pages has changed so lets set up containers for each page again
                $("#gallery").empty();
        ...
        $("a.thumb").hover(function(e){
            $("#thumb").remove();
            $("body").append('<div id="thumb"><img src="' + $(this).attr("href") + '" alt="Preview"></div>');
            positionThumbnail(e);
            $("#thumb").fadeIn("medium");
        },
        function(){
    ...
    <script src="<?php echo $js_uri; ?>/fileupload/libs/jquery.ui.widget.js"></script>
    <!-- The Templates plugin is included to render the upload/download listings -->
    <script src="<?php echo $js_uri; ?>/fileupload/libs/tmpl.min.js"></script>
    <!-- The Load Image plugin is included for the preview images and image resizing functionality -->
    <script src="<?php echo $js_uri; ?>/fileupload/libs/load-image.min.js"></script>
    <!-- The Canvas to Blob plugin is included for image resizing functionality -->
    <script src="<?php echo $js_uri; ?>/fileupload/libs/canvas-to-blob.min.js"></script>
    <!-- Bootstrap JS for nav-tabs -->
    ...
    <script src="<?php echo $js_uri; ?>/bootstrap/bootstrap-image-gallery.min.js"></script>
...
<body>
    ...
    if ('media' == $mediatype) { ?>
        ...
        <li class="active"><a href="#home" data-toggle="tab">Upload Media</a></li>
        <li><a href="#media" data-toggle="tab">Browse Media</a></li>
    <?php
    } else { ?>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="home">
            <div id="upload-img">
                <form name="upload" class="fileuploadsingle" action="<?php echo $link->getAdminLink('AdminLayerSliderMedia'); ?>&action=uploadFile" method="POST" enctype="multipart/form-data">
        ...
        <?php
        } elseif ('media' == $mediatype) { ?>
            <div class="tab-pane" id="media" style="">
            </div>
        <?php
        } ?>
    </div>
