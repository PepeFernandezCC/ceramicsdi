...
namespace Scaledev\MiraklPhpConnector\Field\Order\GetOrdersList\OrdersField\CustomerField\ContactField;
 ...
 */
final class FirstnameField extends AbstractField
{
    const CONSTRAINTS = array(
        RequiredValidator::class,LengthValidator::class,StringTypeValidator::class
    );
