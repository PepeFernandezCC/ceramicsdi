...
namespace Scaledev\MiraklPhpConnector\Model\Customer\CustomerOrganization;

use Scaledev\MiraklPhpConnector\Core\Model\AbstractModel;

/**
 * Class CustomerOrganizationAddress
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class CustomerOrganizationAddress extends AbstractModel
{
    /**
     * City of the contact
     * Api data: city
