...
/**
 * Class GetOfferExportErrorReportResponse
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class GetOfferExportErrorReportResponse extends AbstractResponse
{
    /**
     * Content of the error report as CSV format
     * @var string
     */
    private $reportContent;

    /**
     * @param string $resultRequest
     * @return $this
     */
