...
namespace Scaledev\MiraklPhpConnector\Request\Shop;
...
/**
 * Class GetShopInformationRequest
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class GetShopInformationRequest extends AbstractRequest
{
    /**
     * Defines the response class to use.
     */
    const RESPONSE_CLASS = GetShopInformationResponse::class;
