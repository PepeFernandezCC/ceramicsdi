...
/**
 * Class GetOfferExportErrorReportRequest
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class GetOfferExportErrorReportRequest extends AbstractRequest
{
    /**
     * Defines the response class to use.
     */
    const RESPONSE_CLASS = GetOfferExportErrorReportResponse::class;
