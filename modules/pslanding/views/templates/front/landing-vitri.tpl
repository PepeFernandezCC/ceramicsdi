...
<div id="landing-color">
  <div id="landing-template" class="landing landing-default">
    ...
    <div id="bloque-color-2" id="landing-color-blue-block" class="block-landing" style="background-color:#000000">
      <div class="presentation-landing">
        <div class="presentation-landing-title">
            <h2>
    ...
    <div id="bloque-color-3" class="block-landing">
      ...
      <div class="presentation-landing-title">
        <h2>
          {l s='UNA COLECCIÓN, MÚLTIPLES FORMATOS.' d='Shop.Theme.Catalog'} 
        </h2>
        <p>{l s='El formato define el ritmo, la escala y la percepción del espacio.' d='Shop.Theme.Catalog'} </p>
      </div>
