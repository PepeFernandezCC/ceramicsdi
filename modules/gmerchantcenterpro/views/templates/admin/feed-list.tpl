							...
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane active" id="xml">
									...
									<div id="syncCounterDiv" style="display: none;" class="alert alert-success">
										...
										<div class="row">
											...
											{l s='on' mod='gmerchantcenterpro'}&nbsp;{$iTotalProduct|escape:'htmlall':'UTF-8'} ({l s='total of products on the shop' mod='gmerchantcenterpro'})
										</div>
										<div class="row mt-2">
											<div class="mt-2"></div>
								...
								<div class="tab-pane fade" id="cron" role="tabpanel">
									...
									<div class="alert alert-info form-group">
										{l s='Please follow our FAQ to know' mod='gmerchantcenterpro'}&nbsp;&nbsp;<a class="badge badge-info" target="_blank" href="{$faqUrl|escape:'htmlall':'UTF-8'}{$sFaqLang|escape:'htmlall':'UTF-8'}/faq/30#bt_cron"><i class="icon icon-link"></i>&nbsp;{l s='how to create a CRON task' mod='gmerchantcenterpro'}</a>
										<br /><br />
									...
									<div class="form-group" style="display: none !important;">
										...
										{if !empty($aCronLangProduct)}
											...
											<a class="badge badge-info" href="{$sCronUrlProduct|escape:'htmlall':'UTF-8'}" target="_blank"><i class="icon icon-link"></i>&nbsp;{l s='Execute the CRON in browser' mod='gmerchantcenterpro'}</a>
										{else}
											<div class="col-xs-12 col-md-5 col-lg-5">
