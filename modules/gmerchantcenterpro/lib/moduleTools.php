...
class moduleTools
{
        ...
        if (
            ...
            foreach ($aOptionListToUnserialize as $sOption) {
                if (
                    ...
                    \GMerchantCenterPro::$conf[strtoupper($sOption)] = moduleTools::handleGetConfigurationData(\GMerchantCenterPro::$conf[strtoupper($sOption)], ['allowed_classes' => false]);
                }
            }
        }
    }
    ...
    public static function getLangCurrencyCountry(array $available_languages)
    {
        ...
        $hasData = Feeds::hasSavedData(\GMerchantCenterPro::$iShopId);
        if (!empty($hasData)) {
            $available_feeds = Feeds::getAvailableFeeds((int) \GMerchantCenterPro::$iShopId);
            if (!empty($available_feeds)) {
                foreach ($available_languages as $lang) {
                    $current_feed_shop = Feeds::getFeedLangData($lang['iso_code'], (int) \GMerchantCenterPro::$iShopId);
    ...
    public static function loadGoogleTags()
    {
        return [
            '_no_available_for_order' => [
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('Products not exported because the "available for order" option is not activated', 'moduleTools') . '.',
                'faq_id' => 237,
                'anchor' => '',
            ],
            '_no_product_name' => [
                ...
                'type' => 'error',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('Products not exported because the product name is missing', 'moduleTools') . '.',
                'faq_id' => 210,
                'anchor' => '',
            ],
            '_no_required_data' => [
                ...
                'type' => 'error',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('Products not exported because one of this information is missing: product name or product description or product URL or image URL', 'moduleTools') . '.',
                'faq_id' => 0,
                'anchor' => '',
            ],
            '_no_export_no_supplier_ref' => [
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('Products not exported due to missing MPN reference. Please review the configuration of unique product identifiers', 'moduleTools') . '.',
                'faq_id' => 198,
                'anchor' => '',
            ],
            '_no_export_no_ean_upc' => [
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('Products not exported due to missing EAN/UPC reference. Please review the configuration of unique product identifiers', 'moduleTools') . '.',
                'faq_id' => 192,
                'anchor' => '',
            ],
            '_no_export_no_stock' => [
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('Products not exported due to out of stock export settings', 'moduleTools') . '.',
                'faq_id' => 22,
                'anchor' => '',
            ],
            '_no_export_min_price' => [
                ...
                'type' => 'notice',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('Products not exported due to minimum price settings', 'moduleTools') . '.',
                'faq_id' => 22,
                'anchor' => '',
            ],
            ...
            'condition' => [
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => \GMerchantCenterPro::$oModule->l('The "CONDITION" tag => This is the condition of the item. There are only 3 accepted values: "new", "refurbished" and "used"', 'moduleTools') . '.',
                'faq_id' => 195,
            ...
            'availability' => [
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => \GMerchantCenterPro::$oModule->l('The "AVAILABILITY" tag => This indicates the availability of the item. There are only 3 accepted values: "in stock", "out of stock" and "preorder"', 'moduleTools') . '.',
                'faq_id' => 213,
            ...
            'gender' => [
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('The "GENDER" tag => This tag allows you specify the gender your product is designed for. You can choose between 3 predefined values: "male", "female" or "unisex"', 'moduleTools') . '.',
                'faq_id' => 209,
                'anchor' => 'gender',
            ],
            'age_group' => [
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('The "AGE GROUP" tag => This tag allows you to specify the age group your product is designed for. You can choose between 5 predefined values: "adults", "kids","toddler","infant" or "newborn"', 'moduleTools') . '.',
                'faq_id' => 202,
                'anchor' => 'age_group',
            ],
            'color' => [
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('The "COLOR" tag => This defines the dominant color(s) of an item', 'moduleTools') . '.',
                'faq_id' => 199,
                'anchor' => 'size_color',
            ],
            'size' => [
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('The "SIZE" tag => This indicates the size of an item', 'moduleTools') . '.',
                'faq_id' => 201,
                'anchor' => 'size_color',
            ],
            'sizeType' => [
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('The "SIZE TYPE" tag => This tag allows you to give an additional information about clothing size. You can choose between 6 predefined values: "regular", "petite", "plus", "tall", "big" or "maternity"', 'moduleTools') . '.',
                'faq_id' => 220,
                'anchor' => 'sizeTyp',
            ],
            'sizeSystem' => [
            ...
            'material' => [
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('The "MATERIAL" tag => This tag indicates the main fabric or material that the item is made of', 'moduleTools') . '.',
                'faq_id' => 205,
                'anchor' => 'pattern',
            ],
            'pattern' => [
            ...
            'item_group_id' => [
                ...
                'type' => 'warning',
                'mandatory' => false,
                'msg' => \GMerchantCenterPro::$oModule->l('The "ITEM GROUP ID" tag => All items that are color/material/pattern/size variants of the same product must have the same item group id', 'moduleTools') . '.',
                'faq_id' => 0,
                'anchor' => '',
            ],
            'shipping_weight' => [
            ...
            'shipping' => [
                ...
                'type' => 'error',
                'mandatory' => true,
                'msg' => \GMerchantCenterPro::$oModule->l('The "SHIPPING" tag => The shipping tag lets you override the shipping cost defined in your Merchant Center account for an item', 'moduleTools') . '.',
                'faq_id' => 51,
                'anchor' => '',
            ],
    ...
    {
        $reporting_output = [];
        $reportingList = Reporting::getReportingList(\Gmerchantcenterpro::$iShopId);
    ...
    {
        $saved_taxonomies = Feeds::getSavedTaxonomies((int) \GMerchantCenterPro::$iShopId);
    ...
    public static function getTaxonomiesToImport($isoLang)
    {
        ...
        if (!empty(\Db::getInstance()->executeS($checkGmcTable))) {
            ...
            $gmcQuery->where('gtc.id_shop=' . (int) \Gmerchantcenterpro::$iShopId);
        ...
        if (!empty(\Db::getInstance()->executeS($checkGmcpTable))) {
            ...
            $gmcpQuery->where('gtc.id_shop=' . (int) \Gmerchantcenterpro::$iShopId);
        ...
        if (!empty(\Db::getInstance()->executeS($checkFbdaTable))) {
            ...
            $fbdaQuery->where('gtc.id_shop=' . (int) \Gmerchantcenterpro::$iShopId);
        ...
        if (!empty(\Db::getInstance()->executeS($checkTkpTable))) {
            ...
            $tkpQuery->where('gtc.id_shop=' . (int) \Gmerchantcenterpro::$iShopId);
    ...
    public static function getEstimatedDeliveryDate($order, $shipping_date)
    {
        ...
        $shipping_times = moduleTools::handleGetConfigurationData(\GMerchantCenterPro::$conf['GMCP_SHIP_TIME'], ['allowed_classes' => false]);
