...
var GmcPro = function (sName) {
	...
	this.form = function (sForm, sURI, sRequestParam, sToDisplay, sToHide, bSubmit, bFancyBox, oCallBack, sErrorType, sLoadBar, sScrollTo, iStepUpdate) {
		// Define sSelectElem at the beginning of the function to make it available throughout
		var sSelectElem = 'bt_cl-type'; // Default value for the select element ID
		...
		jQuery.each(fields, function (i, field) {
			...
			switch (field.name) {
				...
				case "bt_cl_dyn_date_start":
					if (field.value == "" && $("#" + sSelectElem).length && $("#" + sSelectElem).val() == "dynamic_new_product") {
				...
				case "bt_cl_dyn_amount":
					if (field.value == "" && $("#" + sSelectElem).length && $("#" + sSelectElem).val() == "dynamic_best_sale") {
