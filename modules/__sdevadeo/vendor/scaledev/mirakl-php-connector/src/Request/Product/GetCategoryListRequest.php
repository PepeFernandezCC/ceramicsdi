...
use Scaledev\MiraklPhpConnector\Model\Category;
use Scaledev\MiraklPhpConnector\Response\Product\GetCategoryListResponse;
 ...
 */
final class GetCategoryListRequest extends AbstractRequest
{
    /**
     * Defines the response class to use.
     */
    const RESPONSE_CLASS = GetCategoryListResponse::class;
    ...
    protected function initResponse()
    {
        ...
        $this->setResponse(
            new $responseClassName(
                json_decode($this->clientResult,1)['hierarchies']
            )
        );
