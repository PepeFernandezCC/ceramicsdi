...
namespace Scaledev\MiraklPhpConnector\Field\Platform\GetCarrierList;
 ...
 */
final class CarrierCollectionField extends AbstractField
{
    /**
     * @inheritdoc
     */
     ...
     * @inheritdoc
     */
    const TYPE = CarrierCollection::class;
