...
namespace Scaledev\MiraklPhpConnector\Field\Product\GetCategoryList;
...
/**
 * Class CarrierCollectionField
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class CategoryCollectionField extends AbstractField
{
    /**
     * @inheritdoc
     */
     ...
     * @inheritdoc
     */
    const TYPE = CategoryCollection::class;
