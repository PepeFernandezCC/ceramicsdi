	...
	class CookieDefine
	{
		...
		public static function getConfigs()
		{
            ...
            $global_settings = [
                ...
                'reload_page_after_accept_cookies' => 0,
                'force_choice_accepting_cookies' => 0,
                'redirect_if_refuse_cookie' => 0,
				'reject_redirect_url' => 'https://www.google.com/'
            ];
            ...
            $cookie_bar = [
                ...
                'design' => [
					...
					'show_reopen_cookie_banner_btn' => 0,
					'hide_reopen_btn_when_accepted_cookies' => 0,
					'use_custom_reopen_btn' => 0,
					'reopen_btn_image' => '',
					'reopen_btn_padding_x' => 12,
					'reopen_btn_padding_y' => 14,
					'reopen_btn_font_size' => 14,
					'reopen_btn_border_radius' => 1000,
					'reopen_btn_text_color' => '#000',
					'reopen_btn_background' => '#fff',
					'reopen_btn_use_transparent' => 0,
					'reopen_btn_active_box_shadow' => 1,
					'reopen_btn_position' => 'left',
					'reopen_btn_offset_x' => 0,
					'reopen_btn_offset_y' => 0,
					'reopen_btn_use_image' => 0,
                ]
            ];
			...
			return array(
				...
				array(
					'name' => 'LABEL_REOPEN_BTN',
					'value' => $label_reopen_btn,
					'lang' => true,
				),
                array(
