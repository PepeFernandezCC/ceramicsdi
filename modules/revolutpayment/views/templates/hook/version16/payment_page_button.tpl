    ...
    {if $currency_error}
        <div id="revolutError">
            <div class="error">
                <ul>
                    <li>
                        {$selected_currency|escape:'htmlall':'UTF-8'}
                        {l s='currency is not supported, please use a different currency to check out. You can check the supported currencies in the ' mod='revolutpayment'}
                        <a target="_blank" href="{$support_link|escape:'htmlall':'UTF-8'}">
                            {l s='[following link]' mod='revolutpayment'}
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="error">
                <ul>
                    <li>
                        ...
                        <a target="_blank" href="{$ps_support_link|escape:'htmlall':'UTF-8'}">
                            {l s='support chat' mod='revolutpayment'}
                        </a>
        ...
        <div class="col-xs-12">
            <div class="revolut-payment">
                {if isset($nbProducts) && $nbProducts <= 0}
                    <p class="warning">
                        {l s='Shopping cart is empty.' mod='revolutpayment'}
                    </p>
                {else}
                            ...
                            <div id="revolutError">
                                <div class="error">
                                    <ul>
                                        <li>
                                            {$selected_currency|escape:'htmlall':'UTF-8'}
                                            {l s='currency is not supported for card payments, please use a different currency to check out. You can check the supported currencies in the ' mod='revolutpayment'}
                                            <a target="_blank" href="{$support_link|escape:'htmlall':'UTF-8'}">
                                                {l s='[following link]' mod='revolutpayment'}
                                            </a>
                                        </li>
                        ...
                        {else}
                            <div class="revolut-payment-form">
                                <form class="revForm"
                                      id="revolutForm"
                                      method="post"
                                      {if $checkoutWidgetDisplayType == 2}
                                          class="payment_page"
                                          action="{$paymentPageLink|escape:'htmlall':'UTF-8'}"
                                      {else}
                                          action="{$action_link|escape:'htmlall':'UTF-8'}"
                                      {/if}>
