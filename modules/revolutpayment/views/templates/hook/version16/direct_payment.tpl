          ...
          {else}
            ...
            {else}
              <form class="revForm" id="revolutForm" method="post" action="{$action_link|escape:'htmlall':'UTF-8'}">
                <input type="hidden" name="payment_method" value="revolut_card">
                ...
                {if $cardholderNameFieldEnabled}
                    <div id="card-holder-name-form" class="form-group">
                        <input id="card-holder-name-field" 
                            type="text" 
                            name="revolut-gateway-cardholder-name-field" 
                            class="form-control" 
