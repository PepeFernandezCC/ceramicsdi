...
class RevolutpaymentPaymentModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        // payment data
        $merchant_type = 'prod';
        if (ServiceProvider::apiConfigProvider()->getConfig()->isSandbox()) {
        ...
        $this->context->smarty->assign([
            ...
            'state' => $state,
            'country' => $country,
            'revolut_payment_title' => $this->module->checkoutCardDisplayTitle,
            'cardholderNameFieldEnabled' => $this->module->isCardHolderNameFieldEnabled(),
