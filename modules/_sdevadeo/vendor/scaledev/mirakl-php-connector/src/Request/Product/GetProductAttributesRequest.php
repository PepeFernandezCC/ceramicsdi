...
use Scaledev\MiraklPhpConnector\Response\Product\GetProductAttributesResponse;

/**
 * Class GetProductAttributesRequest
 *
 * @package Scaledev\MiraklPhpConnector
 * @author Louis Pavoine <contact@scaledev.fr>
 */
final class GetProductAttributesRequest extends AbstractRequest
{
    /**
     * Defines the response class to use.
     */
    const RESPONSE_CLASS = GetProductAttributesResponse::class;
    ...
    protected function initResponse()
    {
        ...
        $this->setResponse(
            new $responseClassName(
                json_decode($this->clientResult,1)['attributes']
            )
        );
