...
/**
 * Class AdminSdevAdeoDescriptionCleaningController
 *
 * @package Scaledev\Adeo
 * @author Pascal Fischer <contact@scaledev.fr>
 */
final class AdminSdevAdeoDescriptionCleaningController extends AbstractModuleAdminController
{
    const TEMPLATE = 'description_cleaning';
