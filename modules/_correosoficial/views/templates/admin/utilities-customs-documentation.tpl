<div class="tab-pane fade" id="documentacion" role="tabpanel" aria-labelledby="documentacion-tab">
    ...
    <div class="row">
        <div class="col-sm-4 offset-md-4">
            ...
            <form id="searchDocAduaneraOrdersForm" name="searchDocAduaneraOrdersForm" class="needs-validation"
                novalidate>
                <div class="input-group mb-3">
                    ...
                    <input type="date" id="inputFromDateCustomsDoc" name="inputFromDateCustomsDoc"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" id="inputToDateCustomsDoc" name="inputToDateCustomsDoc"
                        class="form-control search-utilities-input">
                </div>
                <div class="input-group mb-3">
                    <input id="DocAduaneraSearchButton" name="DocAduaneraSearchButton"
                        class="btn-lg co_primary_button center-block" type="button"
                        value="{l s='Search shipments' mod='correosoficial'}">
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card card-margin card-table-utilities" id="card5">
        ...
        <div id="customsDocumentationTable" class="card-body card-body-custom">
            ...
            <div class="showButtonsContainer5 hidden-block">
                ...
                <a class="toggle-vis5" data-column="9">{l s='ID shop' mod='correosoficial'}</a>
            </div>
            <table id="DocAduaneraDataTable" class="table table-striped" width="100%">
                <thead>
                    <tr>
                        <th><input type="checkbox" name="table-select-all-doc-aduanera" value="1"
                                id="table-select-all-doc-aduanera"></th>
                        <th>ID</th>
                            ...
                            <div class="card align-content-center">
                                <div class="card-body center-block">
                                    <button id="ImprimirCN23Button"
                                        class="btn-lg co_primary_button PrintGestionAduaneraLabels" type="button">
                                    ...
                                    <button id="ImprimirDDPButton"
                                        class="btn-lg co_primary_button PrintGestionAduaneraLabels" type="button"
                                        value="{l s='Print DDP' mod='correosoficial'}">
                                        <span class="spin hidden-block">
                                            <span class="spinner-border spinner-border-sm" role="status"
                                                aria-hidden="true"></span>
                                            <span role="status"
