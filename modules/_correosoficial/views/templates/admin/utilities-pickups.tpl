        ...
        <div class="col-sm-4 offset-md-4">
            ...
            <form id="searchPickupform" name="searchPickupform" class="needs-validation" novalidate>
                <div class="input-group mb-3">
                    ...
                    <input type="date" id="inputFromDatePickups" name="inputFromDatePickups"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" id="inputToDatePickups" name="inputToDatePickups"
                        class="form-control search-utilities-input">
                </div>
                <div class="input-group mb-3">
                    <input id="PickupsSearchButton" name="PickupsSearchButton"
    ...
    <div class="card card-margin card-table-utilities" id="card4">
        ...
        <div id="pickupsTable" class="card-body card-body-custom">
            <div class="alert alert-warning">
                {l s='In this tab only show the Correos orders, anywhere show CEX orders' mod='correosoficial'}</div>
            <a class="show-cols4">{l s='Show/Hide columns' mod='correosoficial'}</a>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#002e6d" class="bi bi-info-circle-fill"
            ...
            <div class="showButtonsContainer4 hidden-block">
                ...
                <a class="toggle-vis4" data-column="12">{l s='ID shop' mod='correosoficial'}</a>
            </div>
            <table id="PickupDataTable" class="table table-striped" width="100%">
                <thead>
                    <tr>
                        <th><input type="checkbox" name="table-select-all-pickups" value="1"
                                id="table-select-all-pickups"></th>
                        <th>ID</th>
            ...
            <div class="row bottom-utilities-form-row">
                <form id="PickupsForm">
                    <div class="col-sm-8">
                        ...
                        <div id="success_pickup_msg"
                            class="alert alert-success alert-dismissible alert-utilities fade hidden-block"
                            role="alert">
                        ...
                        <div class="col-sm-12" id="datatable_errors_pickups_container">
                            ...
                            <div class="card card-custom card-margin">
                                ...
                                <div class="card-body card-body-custom">
                                    <table id="datatableResultsRecogidas" class="table table-striped"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row pickup-date-container">
                                        <div class="col-sm-6">
                                            <div class="input-group input-group-custom mb-3" id="">
                                                ...
                                                <input type="time" id="PickupFrom" name="PickupFrom"
                                                    class="form-control"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group input-group-custom mb-3" id="">
                                                ...
                                                <input type="time" id="PickupTo" name="PickupTo" class="form-control"
                                    ...
                                    <div class="print_and_TamLabelPickups">
                                        ...
                                        <div class="input-group mt-3" id="input_imprimir_etiqueta_container2">
                                            <div class="input-group-addon input-group-checkbox-custom">
                                                <input class="form-check-input mt-0" type="checkbox"
                                                    name="inputPrintLabelPickups" id="inputPrintLabelPickups"
                                                    aria-label="">
                                            </div>
                                        ...
                                        <span class="register-options-advice"><span
                                            ...
                                            </span>{l s='Only Correos shipments. Click if Correos must have the labels printed on pickup' mod='correosoficial'}.</span>

                                        <div class="input-group mt-3" id="input_tamanio_paquete_container2">
                                            <div class="input-group-addon input-group-text-custom">
                                                <span class="input-group-text input-group-text-color"
                                                    for="inputTamLabelPickups">
                                            ...
                                            <select class="custom-select" id="inputTamLabelPickups"
                                                name="inputTamLabelPickups" required>
                                    ...
                                    <button id="generatePickupsButton" class="co_primary_button pull-right mt-3"
                                        type="button">
                                        ...
                                        <span id="generatePickupsButtonMsg" role="status"
                                            aria-hidden="true">{l s='Generate pickups' mod='correosoficial'}</span>
                                    </button>
