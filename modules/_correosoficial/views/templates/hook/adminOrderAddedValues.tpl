        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="row">
                    ...
                    <div id="cash_on_delivery_value_container" class="col-sm-6 ml-0 pl-0 {if (!isset($correos_order['added_values_cash_on_delivery']) || $correos_order['added_values_cash_on_delivery'] == false) && $cash_on_delivery !== true}hidden-block{/if}">
                    ...
                    <div id="bank_acc_number_container" class="col-sm-10 {if (!(isset($correos_order['added_values_cash_on_delivery'])) || $correos_order['added_values_cash_on_delivery'] == false || ($carrier_order['company'] == 'CEX')) && $cash_on_delivery !== true}hidden-block{/if}">
                        <div class="input-group input-group-custom">
                            <div class="input-group-addon input-group-text-custom">
