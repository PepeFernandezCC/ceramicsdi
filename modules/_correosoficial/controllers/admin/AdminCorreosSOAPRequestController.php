...
//require_once dirname(__FILE__).'/../../vendor/ecommerce_common_lib/Correos/CorreosSoapConsole.php';
...
class AdminCorreosSOAPRequestController extends ModuleAdminController
{
    /**
     * @var module
     */
