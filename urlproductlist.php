...
$sql = 'SELECT DISTINCT pl.id_product, pl.id_lang, pl.description, pl.meta_title, pl.name, p.reference
...
echo '<tr><th>ID Producto</th><th>Reference</th><th>URL</th><th>MetaTitle(h1)</th><th>Descripción</th></tr>';
